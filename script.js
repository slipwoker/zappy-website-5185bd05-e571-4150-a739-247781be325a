  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
      ...
      function showError(input, message) {
        var existingError = input.parentNode.querySelector('.' + errorClass);
        if (existingError) {
      ...
      function clearError(input) {
        var errorElement = input.parentNode.querySelector('.' + errorClass);
        if (errorElement) {
          errorElement.remove();
        }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5185bd05-e571-4150-a739-247781be325a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5185bd05-e571-4150-a739-247781be325a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5185bd05-e571-4150-a739-247781be325a';
